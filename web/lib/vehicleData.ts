...
const CATALOGUE_EXTENSIONS: Partial<Record<VehicleType, Record<string, string[]>>> = {
  auto: {
    ...
    Lamborghini: ["Countach", "Espada", "Islero", "Jalpa", "LM002", "Miura", "Revuelto", "Silhouette", "Temerario", "Urraco"],
    ...
    Porsche: ["356", "718 Spyder", "918 Spyder", "Boxster", "Carrera GT", "Cayman", "Mission R", "Taycan Cross Turismo"],
  ...
  moto: {
    Aprilia: ["Dorsoduro", "RS 457", "Tuono V4"],
    BMW: ["C 400 X", "CE 04", "F 750 GS", "F 800 GS", "K 1600 GT", "R 18", "R 1300 GS", "S 1000 R", "S 1000 XR"],
    Ducati: ["996", "999", "DesertX", "Monster SP", "Multistrada V4", "SuperSport", "XDiavel"],
    "Harley-Davidson": ["Breakout", "Electra Glide", "Low Rider S", "Nightster", "Road Glide", "Softail Standard"],
    Honda: [
      "CB1000R",
      "CB500X",
      "CBR650R",
    ...
    Kawasaki: ["Eliminator", "KLX", "Ninja 250", "Versys-X 300", "W800", "Z400", "ZX-25R", "ZX-6R"],
    KTM: ["125 Duke", "250 Duke", "690 Duke", "690 Enduro", "890 Adventure", "990 Duke", "1290 Super Adventure", "RC 390"],
    "Moto Guzzi": ["Griso", "V100 Mandello", "V7 Stone", "V9 Roamer"],
    "MV Agusta": ["Rush", "Superveloce", "Turismo Veloce Lusso"],
    Piaggio: ["1", "Vespa 946"],
    "Royal Enfield": ["Hunter 350", "Scram 411", "Shotgun 650", "Super Meteor 650"],
    Suzuki: ["Address 125", "DR-Z400", "GSX-8R", "GSX-8S", "Katana", "V-Strom 1050"],
    Triumph: ["Rocket 3", "Scrambler 900", "Scrambler 1200", "Speed Twin", "Thruxton", "Tiger 1200"],
    Vespa: ["946", "GTV"],
    Yamaha: ["MT-03", "MT-125", "Niken", "TMAX", "WR250F", "YZF-R3"],
  },
};
